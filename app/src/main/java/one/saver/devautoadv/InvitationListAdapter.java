...
public class InvitationListAdapter extends ArrayAdapter<String> {
    ...
    public InvitationListAdapter(Activity context, String[] itemmake, String[] itemmodel, Integer[] img_logo_id, Integer[] img_is_main_id) {
