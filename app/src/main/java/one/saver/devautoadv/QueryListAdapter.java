...
public class QueryListAdapter extends ArrayAdapter<String> {
    ...
    public QueryListAdapter(Activity context, String[] itemmake, String[] itemmodel, Integer[] img_logo_id, Integer[] img_is_main_id) {
        super(context, R.layout.query_list, itemmake);
    ...
    public View getView(int position,View view,ViewGroup parent) {
        ...
        View rowView=inflater.inflate(R.layout.query_list, null,true);
